...
def gerar_circuito():
    ...
    parametros = ["tensao_total", "corrente_total", "resistencia_eq"] + [f"resistor_{i+1}" for i in range(num_resistores)]
    parametro_faltante = random.choice(parametros)
...
class JogoEletronica:
    ...
    def nova_rodada(self):
        self.circuito, self.parametro_faltante, self.tipo_circuito = gerar_circuito()
